package sheg1_steparm.aquaacrobaticsunofficial.integration.artemislib;
...
public class AttachAttributesFix extends AttachAttributes {
    ...
    public void onEntityRenderPre(final RenderLivingEvent.Pre evt) {
        ...
        if (this.isResizingRequired) {
            ...
            if (entity instanceof IPlayerResizeable && ((IPlayerResizeable) entity).aquaAcrobatics$getPose() == Pose.SWIMMING && ((IPlayerResizeable) entity).aquaAcrobatics$getSwimAnimation(evt.getPartialRenderTick()) > 0.0F) {
                heightAttribute *= 3.0;
            }
